...
public static class GameResources
{
	...
	private static void LoadImages()
	{
		...
		NewImage("Discovery", "discover_coords.jpg");
		NewImage("Deploy", "deploy_coords.jpg");
	...
	private static void PlaySwinGameIntro()
	{
		...
		for (i = 0; i <= ANI_CELL_COUNT - 1; i++) {
			...
			SwinGame.DrawBitmap(_Animation, (i / ANI_V_CELL_COUNT) * ANI_W, (i % ANI_V_CELL_COUNT));
			SwinGame.Delay(20);
			SwinGame.RefreshScreen();
			SwinGame.ProcessEvents();
		}
	...
	private static void ShowMessage(string message, int number)
	{
		...
		SwinGame.DrawText(message, Color.White, _LoadingFont, TX, TY);
		SwinGame.DrawText(message, Color.White,  TX, TY);
